...
async def get_all_subaccounts(drift_client: DriftClient, authority: Pubkey):
    ...
    for sub_id in range(20):
        ...
        try:
            ...
            logger.error(f"Error getting subaccount {sub_id}: {e}")
            continue
    return subaccounts
...
async def liqcalc(drift_client: DriftClient):
    ...
    for market_idx, spot_market in spot_markets.items():
        ...
        current_balance = user.get_token_amount(market_idx) / (10**spot_market.decimals)
    ...
    if st.button("Submit"):
        ...
        try:
            ...
            for spot_pos in user.get_active_spot_positions():
                ...
                if market_idx in balance_changes:
                    delta = int(
                ...
                position = {
                    ...
                    "Delta Applied": balance_changes.get(market_idx, 0),
